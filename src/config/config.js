...
const smtpSettings = {
  service: 'Gmail',
  user: process.env.EMAIL || 'tccmicroservices@gmail.com',
  pass: process.env.EMAIL_PASS || 'tccaprovadonota10'
}
...
module.exports = Object.assign({}, { dbSettings, serverSettings, stripeSettings, smtpSettings})
